...
print("Checking for Sigmoid activation")
# XOR dataset
...
print("\n Predicted Output for sigmoid activation:", output)
...
save_model(model, "xor_solved_w_sigmoid.npz")

# Load the model weights
load_model(model, "xor_solved_w_sigmoid.npz")
