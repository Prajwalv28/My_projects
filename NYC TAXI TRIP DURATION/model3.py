...
cord_columns = ['passenger_count','pickup_hour', 'dropoff_hour', 'distance']
print(" features used in model :", cord_columns)
...
model_hyp = {'l1': 256, 'l2': 128, 'l3': 64, 'lr_rate': 0.1}
print(f"Training model3 with selected hyperparameters configuration")
...
save_model(model, "model3_weights.npz")
...
load_model(loaded_model, "model3_weights.npz")
