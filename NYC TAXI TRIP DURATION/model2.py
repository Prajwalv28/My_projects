...
cord_columns = ['pickup_month','pickup_day', 'dropoff_month','dropoff_day', 'passenger_count']
...
model_hyp = {'l1': 150, 'l2': 100, 'l3': 50, 'lr_rate': 0.1}
print(f"\nTraining model2 with selected hyperparameters configuration\n")
...
save_model(model, "model2_weights.npz")
...
load_model(loaded_model, "model2_weights.npz")
